...
public class TimestampInjector implements BurpExtension {
	...
	api.extension().registerUnloadingHandler(() -> {
            ...
            persist.setInteger("selectedOffsetValue",this.selectedOffsetValue);
            persist.setString("selectedOffset", this.selectedOffset);
            persist.setString("selectedTimeUnit", this.selectedTimeUnit);
            persist.setString("selectedTimezone", this.selectedTimezone);
            persist.setString("selectedDateFormat",this.selectedDateFormat);
        });
    }
